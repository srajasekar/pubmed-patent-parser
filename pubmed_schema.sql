...
-- pubmed_GeniaKeyword(ArticleId, Keyword)
create table pubmed_GeniaKeyword (
    ArticleId integer not null,
    Keyword long varchar not null,
    constraint GENKWDFK1 foreign key(ArticleId) references pubmed_Article(Id)
);
